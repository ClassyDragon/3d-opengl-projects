...
//    trans = glm::translate(trans, glm::vec3(0, 0, -4));
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        trans = glm::translate(trans, glm::vec3(0.0, 2.0, -2.0));
        shader.SetUniformMat4f("trans", trans);
        renderer.Draw(va, ib, shader);
        */
        ...
        ImGui::SliderFloat3("XYZ Rotation", &degrees[0], 0.0f, 360.f);
        ImGui::SliderFloat3("XYZ Translation", &units[0], 0.0f, 10.0f);
